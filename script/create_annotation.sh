...
awk -F '[\t;]' '$3=="start_codon"'      $gtf      >       $annotation_full/transcript.exon.CDS.foo;
...
### scan for the ORFs
echo "------ scan ORFs ------";
awk -F '\t' '$3=="exon"{print $0}'	$gtf	>	$annotation_full/exons.gtf;
perl    $script_dir_full/gtf2Bed.pl       $annotation_full/exons.gtf                 >       $annotation_full/exons.bed;
###    exon fasta and peptide;
bedtools getfasta -fi 	$fa    -name -s -split -bed $annotation_full/exons.bed   -fo $annotation_full/exons.fa;
####    getorf
...
echo "======  annotate ORF ======";
awk -F '[\t;]' '$3=="exon"||$3=="start_codon"||$3=="stop_codon"'        $gtf       >       $annotation_full/transcript.exon.CDS.foo;
...
wc -l $annotation_full/final.annot.1;
wc -l $annotation_full/exons.ORFs.2;
...
wc -l $annotation_full/final.ORFs.annot3;
